...
$(document).ready(function(){
    ...
    $("li.type-book, li.type-ebook").on("click", function(event) { // RG 20.09.2022 przez dodanie playera na stronach kategorii/promocji dodajemy "li", ¿eby nie blokowaæ filtrów
    ...
    $("li.type-audiobook, li.type-dvd").on("click", function(event) { // RG 20.09.2022 przez dodanie playera na stronach kategorii/promocji dodajemy "li", ¿eby nie blokowaæ filtrów | 21.09.2022 dodanie type-dvd
...
//	var btn = $(this).attr("class");
    ...
    // $('#'+button_player).html("Ods³uchaj");
     ...
     $(".jp-stop").hide();
     $('.jp-play').not(this).html("Ods³uchaj");
